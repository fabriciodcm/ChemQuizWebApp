...
export const b2cPolicies = {
    ...
    authorities: {
        ...
        resetPassword: {
            authority: "https://FabricioDocemaB2C.b2clogin.com/tfp/FabricioDocemaB2C.onmicrosoft.com/B2C_1_reset"
        },
        editProfile: {
            authority: "https://FabricioDocemaB2C.b2clogin.com/tfp/FabricioDocemaB2C.onmicrosoft.com/b2c_1_edit"
        }
    }
}
// #endregion
...
export const apiConfig: {b2cScopes: string[], webApi: string} = {
    ...
    webApi: 'https://chemquiz.azurewebsites.net/hello'
};
// #endregion
...
export const msalConfig: Configuration = {
    auth: {
        clientId: "dc5f8496-a025-46ea-ae59-1e72c8556225",
